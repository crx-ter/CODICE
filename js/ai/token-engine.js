/* ═══════════════════════════════════════════════════════════════
   TOKEN ENGINE v7 — CÓDICE
   Real tokenizer (GPT-style BPE approximation)
   Replaces naive char/4 approximation with proper subword counting.
═══════════════════════════════════════════════════════════════ */
...
const TokenEngine = (() => {
  ...
  return { estimate, estimateHistory, budget, summarize };
})();
